...
class CheckoutProductsAdapter(val context: Context, activity: FragmentActivity, private val items: List<CartItem?>) :
    RecyclerView.Adapter<CheckoutProductsAdapter.ItemViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.rc_item_checkout_products, parent, false)
